...
if (in_array($next_option->id, [2, 4])) {
    //去掉这些行是为了全局使用datetimepicker.js和select2.js
    ...
    echo $form->dropDownListGroup($model,  'middleman', array('groupOptions' => array('class' => '', 'style' => 'width:28%;margin-left:15px;'), 'widgetOptions' => array('data' => UserInfo::model()->getUserNames(), 'htmlOptions' => array('class'=>'s2id_TalentStatus_middleman','style' => 'width:100%;min-width:0px;', 'id' => 's2id_TalentStatus_middleman' . $data->id))));
    echo $form->textFieldGroup($model, 'setup_datetime', array('groupOptions' => array('class' => '', 'style' => 'width:40%;margin-left:15px;'),'widgetOptions' => array('htmlOptions' => array('style' => 'min-width:0px;width: 100%;', 'class'=>'TalentStatus_setup_datetime','id' => 'TalentStatus_setup_datetime' . $data->id),) ));
